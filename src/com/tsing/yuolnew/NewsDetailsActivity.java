...
import com.tsing.yuolnew.Parameter;
...
public class NewsDetailsActivity extends Activity
{
    ...
    private String getNewsBody()
    {
      ...
      // String url = "http://10.0.2.2:8080/web/getNews";
       String url = "http://192.168.0.100:8080/web/getNews";
        //http://192.168.75.130
       // String url = "http://192.168.75.130:8080/web/getNews";
       // String url = "http://122.189.89.234:8080/web/getNews";
    ...
    private class PostCommentThread extends Thread
    {
        ...
        public void run()
        {
         ...
         String url = "http://192.168.0.100:8080/web/postComment";
            //String url = "http://192.168.75.130:8080/web/postComment";
           // String url = "http://122.189.89.234:8080/web/postComment";
            List<Parameter> params = new ArrayList<Parameter>();
            params.add(new Parameter("nid", mNid + ""));
            params.add(new Parameter("region", "荆州市"));
